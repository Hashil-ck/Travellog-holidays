  ...
  return (
    ...
    >
      <div className="container-luxury section-luxury">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-6">
            <div className="flex items-center space-x-3">
              <div className="p-2 rounded-full bg-luxury-gold/10">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-sm font-luxury font-semibold text-luxury-gold tracking-[0.2em] -mt-1">
                  HOLIDAYS
                </span>
              </div>
            </div>
            ...
            <div className="flex space-x-4">
              <a
                href="#"
                className="p-2 rounded-full bg-luxury-gold/10 text-luxury-gold hover:bg-luxury-gold hover:text-luxury-black transition-all duration-500 hover:scale-110"
              >
            ...
            <ul className="space-y-3">
              {services.map((service, index) => (
                <li key={index}>
                  <Link
                    href="/services"
                    className="text-luxury-white/70 hover:text-luxury-gold transition-colors duration-500 text-sm font-luxury font-light tracking-wide"
                  >
                    {service}
                  </Link>
                </li>
          ...
          <div className="space-y-6">
            ...
            <Link
              href="/destinations"
              className="text-luxury-gold hover:text-luxury-white transition-colors duration-500 text-sm font-luxury font-semibold tracking-wider uppercase flex items-center gap-2"
            >
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-3">
                ...
                <a
                  ...
                  className="text-luxury-white/70 hover:text-luxury-gold transition-colors duration-500 text-sm font-luxury font-light"
                >
                  +91 8089631604
                </a>
              </div>
              ...
              <div className="flex items-start space-x-3">
                <div className="p-2 rounded-full bg-luxury-gold/10 mt-1">
        ...
        {/* Bottom Bar */}
        <div className="border-t border-luxury-gold/20 mt-16 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="flex space-x-8">
              <Link
                href="/privacy"
                className="text-luxury-white/50 hover:text-luxury-gold transition-colors duration-500 text-sm font-luxury font-light tracking-wide"
              >
                Privacy Policy
              </Link>
              <Link
